export default {
  ...
  isPreview: process.env.NUXT_PUBLIC_IS_PREVIEW === '1',
  ...
  brandThemeEnabled: process.env.NUXT_PUBLIC_BRAND_THEME_ENABLED ?? 'true',
  brandBackgroundTextureEnabled: process.env.NUXT_PUBLIC_BRAND_BACKGROUND_TEXTURE_ENABLED ?? 'true',
  brandPageColor: process.env.NUXT_PUBLIC_BRAND_PAGE_COLOR || '#050505',
  brandSurfaceColor: process.env.NUXT_PUBLIC_BRAND_SURFACE_COLOR || '#111315',
  brandRaisedSurfaceColor: process.env.NUXT_PUBLIC_BRAND_RAISED_SURFACE_COLOR || '#181b1f',
  brandBorderColor: process.env.NUXT_PUBLIC_BRAND_BORDER_COLOR || '#343a40',
  brandTextColor: process.env.NUXT_PUBLIC_BRAND_TEXT_COLOR || '#f4f4f5',
  brandMutedTextColor: process.env.NUXT_PUBLIC_BRAND_MUTED_TEXT_COLOR || '#b9c0c8',
  brandPriceColor: process.env.NUXT_PUBLIC_BRAND_PRICE_COLOR || '#ff5a4f',
