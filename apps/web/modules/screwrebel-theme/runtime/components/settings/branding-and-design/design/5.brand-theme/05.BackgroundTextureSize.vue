...
<i18n lang="json">
{
  ...
  "de": {
    "label": "Größe der Hintergrundtextur",
    "description": "Abdecken eignet sich für große Bildtexturen. Originalgröße ist für kleine nahtlose Muster sinnvoll.",
    "option-cover": "Abdecken",
    "option-contain": "Einpassen",
    "option-auto": "Originalgröße"
  }
}
</i18n>
