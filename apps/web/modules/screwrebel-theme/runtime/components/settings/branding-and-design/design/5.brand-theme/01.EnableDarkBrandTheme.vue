<template>
  <div class="py-2">
    <div class="flex justify-between mb-2">
      ...
      <SfSwitch
        v-model="enableDarkBrandTheme"
        data-testid="enable-dark-brand-theme"
...
const { updateSetting, getBooleanSetting } = useSiteSettings('enableDarkBrandTheme');
...
<i18n lang="json">
{
  ...
  "de": {
    "label": "Enable theme",
    "tooltip": "Aktiviert das SCREWREBEL-Shopdesign für Inhalts-, Kategorie- und Produktseiten. Checkout, Konto und Anmeldung behalten bewusst das zugängliche Standarddesign."
  }
}
</i18n>
