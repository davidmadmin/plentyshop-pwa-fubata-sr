import type { PriceFontPreset, PriceFontPresetId } from './types';
...
/**
 * Resolves a supported price-font preset by its persisted setting value.
 */
export const getPriceFontPreset = (presetId: string): PriceFontPreset | null =>
  priceFontPresets[presetId as PriceFontPresetId] ?? null;

/**
 * Builds the reactive head configuration for the selected price font.
 */
