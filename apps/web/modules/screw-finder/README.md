...
when navigating back or restarting, and Terrace or Roofing infer an outdoor A2/A4 requirement when the configurable
environment question is disabled. Application conflicts are shown only as alternatives, and all result-card guidance
